...
export default {
  id: "3rdRatSwarm",
  name: translationStrings.characters["3rdRatSwarm"].name,
  image: image,
  number: 13,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters["3rdRatSwarm"].special1.name,
          description:
            translationStrings.characters["3rdRatSwarm"].special1.description,
        },
      ],
    },
  ],
