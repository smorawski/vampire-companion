...
export default {
  id: "1stShamblingRisenDead",
  name: translationStrings.characters["1stShamblingRisenDead"].name,
  image: image,
  number: 31,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters["1stShamblingRisenDead"].special1
            .name,
          description:
            translationStrings.characters["1stShamblingRisenDead"].special1
              .description,
        },
      ],
    },
