...
export default {
  id: "1stWolf",
  name: translationStrings.characters["1stWolf"].name,
  image: image,
  number: 67,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters["1stWolf"].special1.name,
          description:
            translationStrings.characters["1stWolf"].special1.description,
        },
      ],
    },
  ],
