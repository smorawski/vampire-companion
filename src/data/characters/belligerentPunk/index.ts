...
export default {
  id: "belligerentPunk",
  name: translationStrings.characters.belligerentPunk.name,
  image: image,
  number: 52,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters.belligerentPunk.special1.name,
          description:
            translationStrings.characters.belligerentPunk.special1.description,
        },
      ],
    },
  ],
