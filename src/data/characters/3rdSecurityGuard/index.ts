...
export default {
  id: "3rdSecurityGuard",
  name: translationStrings.characters["3rdSecurityGuard"].name,
  image: image,
  number: 37,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters["3rdSecurityGuard"].special1.name,
          description:
            translationStrings.characters["3rdSecurityGuard"].special1
              .description,
        },
      ],
    },
