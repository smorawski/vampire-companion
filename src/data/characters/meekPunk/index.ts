...
export default {
  id: "meekPunk",
  name: translationStrings.characters.meekPunk.name,
  image: image,
  number: 50,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters.meekPunk.special1.name,
          description:
            translationStrings.characters.meekPunk.special1.description,
        },
      ],
    },
  ],
