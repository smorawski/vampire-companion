...
export default {
  id: "1stHulkingRisenDead",
  name: translationStrings.characters["1stHulkingRisenDead"].name,
  image: image,
  number: 32,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters["1stHulkingRisenDead"].special1
            .name,
          description:
            translationStrings.characters["1stHulkingRisenDead"].special1
              .description,
        },
      ],
    },
