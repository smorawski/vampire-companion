...
export default {
  id: "2ndWolf",
  name: translationStrings.characters["2ndWolf"].name,
  image: image,
  number: 68,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters["2ndWolf"].special1.name,
          description:
            translationStrings.characters["2ndWolf"].special1.description,
        },
      ],
    },
  ],
