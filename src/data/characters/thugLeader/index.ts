...
export default {
  id: "thugLeader",
  name: translationStrings.characters.thugLeader.name,
  image: image,
  number: 3,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters.thugLeader.special1.name,
          description:
            translationStrings.characters.thugLeader.special1.description,
        },
      ],
    },
  ],
