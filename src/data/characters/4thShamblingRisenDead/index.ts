...
export default {
  id: "4thShamblingRisenDead",
  name: translationStrings.characters["4thShamblingRisenDead"].name,
  image: image,
  number: 31,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters["4thShamblingRisenDead"].special1
            .name,
          description:
            translationStrings.characters["4thShamblingRisenDead"].special1
              .description,
        },
      ],
    },
