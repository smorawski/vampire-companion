...
export default {
  id: "1stConstructionWorker",
  name: translationStrings.characters["1stConstructionWorker"].name,
  image: image,
  number: 40,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters["1stConstructionWorker"].special1
            .name,
          description:
            translationStrings.characters["1stConstructionWorker"].special1
              .description,
        },
      ],
    },
