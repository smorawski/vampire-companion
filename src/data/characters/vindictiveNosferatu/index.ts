...
export default {
  id: "vindictiveNosferatu",
  name: translationStrings.characters.vindictiveNosferatu.name,
  image: image,
  number: 46,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters.vindictiveNosferatu.special1.name,
          description:
            translationStrings.characters.vindictiveNosferatu.special1
              .description,
        },
      ],
    },
