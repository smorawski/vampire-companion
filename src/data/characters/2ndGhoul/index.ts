...
export default {
  id: "2ndGhoul",
  name: translationStrings.characters["2ndGhoul"].name,
  image: image,
  number: 73,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters["2ndGhoul"].special1.name,
          description:
            translationStrings.characters["2ndGhoul"].special1.description,
        },
      ],
    },
  ],
