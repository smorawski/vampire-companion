...
export default {
  id: "3rdShamblingRisenDead",
  name: translationStrings.characters["3rdShamblingRisenDead"].name,
  image: image,
  number: 31,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters["3rdShamblingRisenDead"].special1
            .name,
          description:
            translationStrings.characters["3rdShamblingRisenDead"].special1
              .description,
        },
      ],
    },
