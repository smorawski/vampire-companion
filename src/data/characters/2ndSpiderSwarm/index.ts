...
export default {
  id: "2ndSpiderSwarm",
  name: translationStrings.characters["2ndSpiderSwarm"].name,
  image: image,
  number: 78,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters["2ndSpiderSwarm"].special1.name,
          description:
            translationStrings.characters["2ndSpiderSwarm"].special1
              .description,
        },
      ],
    },
