...
export default {
  id: "3rdConstructionWorker",
  name: translationStrings.characters["3rdConstructionWorker"].name,
  image: image,
  number: 43,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters["3rdConstructionWorker"].special1
            .name,
          description:
            translationStrings.characters["3rdConstructionWorker"].special1
              .description,
        },
      ],
    },
