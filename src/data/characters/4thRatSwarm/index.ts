...
export default {
  id: "4thRatSwarm",
  name: translationStrings.characters["4thRatSwarm"].name,
  image: image,
  number: 13,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters["4thRatSwarm"].special1.name,
          description:
            translationStrings.characters["4thRatSwarm"].special1.description,
        },
      ],
    },
  ],
