...
export default {
  id: "brujah",
  name: translationStrings.characters.brujah.name,
  image: image,
  number: 53,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters.brujah.special1.name,
          description:
            translationStrings.characters.brujah.special1.description,
        },
      ],
    },
  ],
