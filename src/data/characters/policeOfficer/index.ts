...
export default {
  id: "policeOfficer",
  name: translationStrings.characters.policeOfficer.name,
  image: image,
  number: 38,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters.policeOfficer.special1.name,
          description:
            translationStrings.characters.policeOfficer.special1.description,
        },
      ],
    },
  ],
