...
export default {
  id: "3rdHulkingRisenDead",
  name: translationStrings.characters["3rdHulkingRisenDead"].name,
  image: image,
  number: 32,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters["3rdHulkingRisenDead"].special1
            .name,
          description:
            translationStrings.characters["3rdHulkingRisenDead"].special1
              .description,
        },
      ],
    },
