...
export default {
  id: "constructionBoss",
  name: translationStrings.characters.constructionBoss.name,
  image: image,
  number: 39,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters.constructionBoss.special1.name,
          description:
            translationStrings.characters.constructionBoss.special1.description,
        },
      ],
    },
  ],
