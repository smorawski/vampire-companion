...
export default {
  id: "rookieGuard",
  name: translationStrings.characters.rookieGuard.name,
  image: image,
  number: 20,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters.rookieGuard.special1.name,
          description:
            translationStrings.characters.rookieGuard.special1.description,
        },
      ],
    },
  ],
