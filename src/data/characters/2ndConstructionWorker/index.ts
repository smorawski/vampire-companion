...
export default {
  id: "2ndConstructionWorker",
  name: translationStrings.characters["2ndConstructionWorker"].name,
  image: image,
  number: 41,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters["2ndConstructionWorker"].special1
            .name,
          description:
            translationStrings.characters["2ndConstructionWorker"].special1
              .description,
        },
      ],
    },
