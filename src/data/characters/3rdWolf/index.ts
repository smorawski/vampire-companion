...
export default {
  id: "3rdWolf",
  name: translationStrings.characters["3rdWolf"].name,
  image: image,
  number: 69,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters["3rdWolf"].special1.name,
          description:
            translationStrings.characters["3rdWolf"].special1.description,
        },
      ],
    },
  ],
