...
export default {
  id: "hostileGangrel",
  name: translationStrings.characters.hostileGangrel.name,
  image: image,
  number: 47,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters.hostileGangrel.special1.name,
          description:
            translationStrings.characters.hostileGangrel.special1.description,
        },
      ],
    },
  ],
