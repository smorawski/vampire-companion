...
export default {
  id: "3rdSIAgent",
  name: translationStrings.characters["3rdSIAgent"].name,
  image: image,
  number: 62,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters["3rdSIAgent"].special1.name,
          description:
            translationStrings.characters["3rdSIAgent"].special1.description,
        },
      ],
    },
  ],
