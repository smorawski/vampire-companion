...
export default {
  id: "2ndHulkingRisenDead",
  name: translationStrings.characters["2ndHulkingRisenDead"].name,
  image: image,
  number: 32,
  ...
  phases: [
    {
      ...
      specials: [
        {
          name: translationStrings.characters["2ndHulkingRisenDead"].special1
            .name,
          description:
            translationStrings.characters["2ndHulkingRisenDead"].special1
              .description,
        },
      ],
    },
